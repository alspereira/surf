...
public class Span implements Serializable, Cloneable {
	private static final long serialVersionUID = -357446437679180185L;
	
	public static final Comparator<Object>	startComparator	= new StartComparator();
	public static final Comparator<Object>	stopComparator	= new StopComparator();
	...
	private static class StopComparator implements Comparator<Object> {
