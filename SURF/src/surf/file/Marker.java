 ...
 */
public class Marker implements Cloneable, Comparable<Object>, Serializable {
	
	private static final long serialVersionUID = 5093416973540128066L;
	...
	/**
	 *  type value : label marker type
	 */
	public static final int TYPE_LABEL		= 0;
	/**
	 *  type value : note marker type
	 */
	 ...
	 */
	public static int add( List<Marker> markers, Marker marker ) {
		int i;
	 ...
	 */	
	public static int find( List<Marker> markers, String name, int startIndex ) {
		for( int i = startIndex; i < markers.size(); i++ ) {
			if( ((Marker) markers.get( i )).name.equals( name )) 
				return i;
		}
		return -1;
	}
		...
		public int compare( Object o1, Object o2 ) {
			if( o1 instanceof String ) {
				if( o2 instanceof String ) {
					...
					return( ((Comparable<String>) (String) o1).compareTo( ((Marker) o2).name ));
				} else if( o2 instanceof Region ) {
					return( ((Comparable<String>) (String) o1).compareTo( ((Region) o2).name ));
				}
			} else if( o1 instanceof Marker ) {
				if( o2 instanceof String ) {
					return( ((Comparable<String>) ((Marker) o1).name).compareTo( (String) o2 ));
				} else if( o2 instanceof Marker ) {
				...
				if( o2 instanceof String ) {
					return( ((Comparable<String>) ((Region) o1).name).compareTo( (String) o2 ));
				} else if( o2 instanceof Marker ) {
