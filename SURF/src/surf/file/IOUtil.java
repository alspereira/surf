...
public class IOUtil
{
	 ...
	 *  @see	File#mkdirs()
	 */
	public static void createEmptyDirectory( File f ) throws IOException {
		deleteAll( f );
		if( !f.mkdirs() ) {
	 ...
	 */
	public static void createEmptyFile( File f ) throws IOException {
		f.delete();
	 ...
	 *  all files and sub folders in the
