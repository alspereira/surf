...
public class SURFTag {
	...
	public static void main(String[] args) {
		...
		try {
			...
			// Add some comments
			comments.add(new Annotation("The metadata schema is use is the one from the NILM metadata project"
			...
			comments.add( new Annotation("The original metadata files can be found in the assets folder of the"
					+ " project source code (see: http://github.com/alspereira/surf)") );
